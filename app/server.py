...
def generate_report():
    ...
    title_style = ParagraphStyle('t', fontSize=22, textColor=GREEN, fontName='Helvetica-Bold', spaceAfter=6)
    sub_style = ParagraphStyle('s', fontSize=11, textColor=colors.HexColor('#666666'), fontName='Helvetica', spaceAfter=20)
